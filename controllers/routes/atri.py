...
class Atri:
	def __init__(self, state: Any):
		...
		self.Flex827 = state["Flex827"]
		self.Flex825 = state["Flex825"]
		self.Div37card = state["Div37card"]
		self.Flex820 = state["Flex820"]
		self.Div38card = state["Div38card"]
		self.Flex821 = state["Flex821"]
		self.Div39card = state["Div39card"]
		self.Flex822 = state["Flex822"]
		self.Flex826 = state["Flex826"]
		self.Div2card = state["Div2card"]
		self.Div3lay = state["Div3lay"]
		self.Flex797content = state["Flex797content"]
		self.Div25card = state["Div25card"]
		self.Flex814 = state["Flex814"]
		self.Div27card = state["Div27card"]
		self.Flex815 = state["Flex815"]
		...
		self.Div34lay = state["Div34lay"]
		self.TextBox573 = state["TextBox573"]
		self.Image335 = state["Image335"]
		self.TextBox574 = state["TextBox574"]
		self.TextBox575 = state["TextBox575"]
		self.Div35lay = state["Div35lay"]
		self.TextBox576 = state["TextBox576"]
		self.Image336 = state["Image336"]
		self.TextBox577 = state["TextBox577"]
		self.TextBox578 = state["TextBox578"]
		self.Div36lay = state["Div36lay"]
		self.TextBox579 = state["TextBox579"]
		self.TextBox580 = state["TextBox580"]
		self.Image337 = state["Image337"]
		self.TextBox581 = state["TextBox581"]
		self.TextBox531 = state["TextBox531"]
		self.TextBox530 = state["TextBox530"]
		self.Image320 = state["Image320"]
		self.TextBox536 = state["TextBox536"]
		self.Div24lay = state["Div24lay"]
		self.TextBox558 = state["TextBox558"]
		self.TextBox559 = state["TextBox559"]
		self.Image330 = state["Image330"]
		self.TextBox560 = state["TextBox560"]
		self.Div26lay = state["Div26lay"]
		self.TextBox561 = state["TextBox561"]
		self.TextBox562 = state["TextBox562"]
		self.Image331 = state["Image331"]
		self.TextBox563 = state["TextBox563"]
		self._setter_access_tracker = {}
	...
	@property
	def Flex827(self):
		self._getter_access_tracker["Flex827"] = {}
		return self._Flex827
	@Flex827.setter
	def Flex827(self, new_state):
		self._setter_access_tracker["Flex827"] = {}
		global default_state
		self._Flex827 = Flex(new_state, default_state["Flex827"])

	@property
	def Flex825(self):
		self._getter_access_tracker["Flex825"] = {}
		return self._Flex825
	@Flex825.setter
	def Flex825(self, new_state):
		self._setter_access_tracker["Flex825"] = {}
		global default_state
		self._Flex825 = Flex(new_state, default_state["Flex825"])

	@property
	def Div37card(self):
		self._getter_access_tracker["Div37card"] = {}
		return self._Div37card
	@Div37card.setter
	def Div37card(self, new_state):
		self._setter_access_tracker["Div37card"] = {}
		global default_state
		self._Div37card = Div(new_state, default_state["Div37card"])

	@property
	def Flex820(self):
		self._getter_access_tracker["Flex820"] = {}
		return self._Flex820
	@Flex820.setter
	def Flex820(self, new_state):
		self._setter_access_tracker["Flex820"] = {}
		global default_state
		self._Flex820 = Flex(new_state, default_state["Flex820"])

	@property
	def Div38card(self):
		self._getter_access_tracker["Div38card"] = {}
		return self._Div38card
	@Div38card.setter
	def Div38card(self, new_state):
		self._setter_access_tracker["Div38card"] = {}
		global default_state
		self._Div38card = Div(new_state, default_state["Div38card"])

	@property
	def Flex821(self):
		self._getter_access_tracker["Flex821"] = {}
		return self._Flex821
	@Flex821.setter
	def Flex821(self, new_state):
		self._setter_access_tracker["Flex821"] = {}
		global default_state
		self._Flex821 = Flex(new_state, default_state["Flex821"])

	@property
	def Div39card(self):
		self._getter_access_tracker["Div39card"] = {}
		return self._Div39card
	@Div39card.setter
	def Div39card(self, new_state):
		self._setter_access_tracker["Div39card"] = {}
		global default_state
		self._Div39card = Div(new_state, default_state["Div39card"])

	@property
	def Flex822(self):
		self._getter_access_tracker["Flex822"] = {}
		return self._Flex822
	@Flex822.setter
	def Flex822(self, new_state):
		self._setter_access_tracker["Flex822"] = {}
		global default_state
		self._Flex822 = Flex(new_state, default_state["Flex822"])

	@property
	def Flex826(self):
		self._getter_access_tracker["Flex826"] = {}
		return self._Flex826
	@Flex826.setter
	def Flex826(self, new_state):
		self._setter_access_tracker["Flex826"] = {}
		global default_state
		self._Flex826 = Flex(new_state, default_state["Flex826"])

	@property
	def Div2card(self):
		self._getter_access_tracker["Div2card"] = {}
		return self._Div2card
	@Div2card.setter
	def Div2card(self, new_state):
		self._setter_access_tracker["Div2card"] = {}
		global default_state
		self._Div2card = Div(new_state, default_state["Div2card"])

	@property
	def Div3lay(self):
		self._getter_access_tracker["Div3lay"] = {}
		return self._Div3lay
	@Div3lay.setter
	def Div3lay(self, new_state):
		self._setter_access_tracker["Div3lay"] = {}
		global default_state
		self._Div3lay = Div(new_state, default_state["Div3lay"])

	@property
	def Flex797content(self):
		self._getter_access_tracker["Flex797content"] = {}
		return self._Flex797content
	@Flex797content.setter
	def Flex797content(self, new_state):
		self._setter_access_tracker["Flex797content"] = {}
		global default_state
		self._Flex797content = Flex(new_state, default_state["Flex797content"])

	@property
	def Div25card(self):
		self._getter_access_tracker["Div25card"] = {}
		return self._Div25card
	@Div25card.setter
	def Div25card(self, new_state):
		self._setter_access_tracker["Div25card"] = {}
		global default_state
		self._Div25card = Div(new_state, default_state["Div25card"])

	@property
	def Flex814(self):
		self._getter_access_tracker["Flex814"] = {}
		return self._Flex814
	@Flex814.setter
	def Flex814(self, new_state):
		self._setter_access_tracker["Flex814"] = {}
		global default_state
		self._Flex814 = Flex(new_state, default_state["Flex814"])

	@property
	def Div27card(self):
		self._getter_access_tracker["Div27card"] = {}
		return self._Div27card
	@Div27card.setter
	def Div27card(self, new_state):
		self._setter_access_tracker["Div27card"] = {}
		global default_state
		self._Div27card = Div(new_state, default_state["Div27card"])

	@property
	def Flex815(self):
		self._getter_access_tracker["Flex815"] = {}
		return self._Flex815
	@Flex815.setter
	def Flex815(self, new_state):
		self._setter_access_tracker["Flex815"] = {}
		global default_state
		self._Flex815 = Flex(new_state, default_state["Flex815"])
	...
	@property
	def Div34lay(self):
		self._getter_access_tracker["Div34lay"] = {}
		return self._Div34lay
	@Div34lay.setter
	def Div34lay(self, new_state):
		self._setter_access_tracker["Div34lay"] = {}
		global default_state
		self._Div34lay = Div(new_state, default_state["Div34lay"])

	@property
	def TextBox573(self):
		self._getter_access_tracker["TextBox573"] = {}
		return self._TextBox573
	@TextBox573.setter
	def TextBox573(self, new_state):
		self._setter_access_tracker["TextBox573"] = {}
		global default_state
		self._TextBox573 = TextBox(new_state, default_state["TextBox573"])

	@property
	def Image335(self):
		self._getter_access_tracker["Image335"] = {}
		return self._Image335
	@Image335.setter
	def Image335(self, new_state):
		self._setter_access_tracker["Image335"] = {}
		global default_state
		self._Image335 = Image(new_state, default_state["Image335"])

	@property
	def TextBox574(self):
		self._getter_access_tracker["TextBox574"] = {}
		return self._TextBox574
	@TextBox574.setter
	def TextBox574(self, new_state):
		self._setter_access_tracker["TextBox574"] = {}
		global default_state
		self._TextBox574 = TextBox(new_state, default_state["TextBox574"])

	@property
	def TextBox575(self):
		self._getter_access_tracker["TextBox575"] = {}
		return self._TextBox575
	@TextBox575.setter
	def TextBox575(self, new_state):
		self._setter_access_tracker["TextBox575"] = {}
		global default_state
		self._TextBox575 = TextBox(new_state, default_state["TextBox575"])

	@property
	def Div35lay(self):
		self._getter_access_tracker["Div35lay"] = {}
		return self._Div35lay
	@Div35lay.setter
	def Div35lay(self, new_state):
		self._setter_access_tracker["Div35lay"] = {}
		global default_state
		self._Div35lay = Div(new_state, default_state["Div35lay"])

	@property
	def TextBox576(self):
		self._getter_access_tracker["TextBox576"] = {}
		return self._TextBox576
	@TextBox576.setter
	def TextBox576(self, new_state):
		self._setter_access_tracker["TextBox576"] = {}
		global default_state
		self._TextBox576 = TextBox(new_state, default_state["TextBox576"])

	@property
	def Image336(self):
		self._getter_access_tracker["Image336"] = {}
		return self._Image336
	@Image336.setter
	def Image336(self, new_state):
		self._setter_access_tracker["Image336"] = {}
		global default_state
		self._Image336 = Image(new_state, default_state["Image336"])

	@property
	def TextBox577(self):
		self._getter_access_tracker["TextBox577"] = {}
		return self._TextBox577
	@TextBox577.setter
	def TextBox577(self, new_state):
		self._setter_access_tracker["TextBox577"] = {}
		global default_state
		self._TextBox577 = TextBox(new_state, default_state["TextBox577"])

	@property
	def TextBox578(self):
		self._getter_access_tracker["TextBox578"] = {}
		return self._TextBox578
	@TextBox578.setter
	def TextBox578(self, new_state):
		self._setter_access_tracker["TextBox578"] = {}
		global default_state
		self._TextBox578 = TextBox(new_state, default_state["TextBox578"])

	@property
	def Div36lay(self):
		self._getter_access_tracker["Div36lay"] = {}
		return self._Div36lay
	@Div36lay.setter
	def Div36lay(self, new_state):
		self._setter_access_tracker["Div36lay"] = {}
		global default_state
		self._Div36lay = Div(new_state, default_state["Div36lay"])

	@property
	def TextBox579(self):
		self._getter_access_tracker["TextBox579"] = {}
		return self._TextBox579
	@TextBox579.setter
	def TextBox579(self, new_state):
		self._setter_access_tracker["TextBox579"] = {}
		global default_state
		self._TextBox579 = TextBox(new_state, default_state["TextBox579"])

	@property
	def TextBox580(self):
		self._getter_access_tracker["TextBox580"] = {}
		return self._TextBox580
	@TextBox580.setter
	def TextBox580(self, new_state):
		self._setter_access_tracker["TextBox580"] = {}
		global default_state
		self._TextBox580 = TextBox(new_state, default_state["TextBox580"])

	@property
	def Image337(self):
		self._getter_access_tracker["Image337"] = {}
		return self._Image337
	@Image337.setter
	def Image337(self, new_state):
		self._setter_access_tracker["Image337"] = {}
		global default_state
		self._Image337 = Image(new_state, default_state["Image337"])

	@property
	def TextBox581(self):
		self._getter_access_tracker["TextBox581"] = {}
		return self._TextBox581
	@TextBox581.setter
	def TextBox581(self, new_state):
		self._setter_access_tracker["TextBox581"] = {}
		global default_state
		self._TextBox581 = TextBox(new_state, default_state["TextBox581"])
	...
	@property
	def Image320(self):
		self._getter_access_tracker["Image320"] = {}
		return self._Image320
	@Image320.setter
	def Image320(self, new_state):
		self._setter_access_tracker["Image320"] = {}
		global default_state
		self._Image320 = Image(new_state, default_state["Image320"])

	@property
	def TextBox536(self):
		self._getter_access_tracker["TextBox536"] = {}
		return self._TextBox536
	@TextBox536.setter
	def TextBox536(self, new_state):
		self._setter_access_tracker["TextBox536"] = {}
		global default_state
		self._TextBox536 = TextBox(new_state, default_state["TextBox536"])

	@property
	def Div24lay(self):
		self._getter_access_tracker["Div24lay"] = {}
		return self._Div24lay
	@Div24lay.setter
	def Div24lay(self, new_state):
		self._setter_access_tracker["Div24lay"] = {}
		global default_state
		self._Div24lay = Div(new_state, default_state["Div24lay"])

	@property
	def TextBox558(self):
		self._getter_access_tracker["TextBox558"] = {}
		return self._TextBox558
	@TextBox558.setter
	def TextBox558(self, new_state):
		self._setter_access_tracker["TextBox558"] = {}
		global default_state
		self._TextBox558 = TextBox(new_state, default_state["TextBox558"])

	@property
	def TextBox559(self):
		self._getter_access_tracker["TextBox559"] = {}
		return self._TextBox559
	@TextBox559.setter
	def TextBox559(self, new_state):
		self._setter_access_tracker["TextBox559"] = {}
		global default_state
		self._TextBox559 = TextBox(new_state, default_state["TextBox559"])

	@property
	def Image330(self):
		self._getter_access_tracker["Image330"] = {}
		return self._Image330
	@Image330.setter
	def Image330(self, new_state):
		self._setter_access_tracker["Image330"] = {}
		global default_state
		self._Image330 = Image(new_state, default_state["Image330"])

	@property
	def TextBox560(self):
		self._getter_access_tracker["TextBox560"] = {}
		return self._TextBox560
	@TextBox560.setter
	def TextBox560(self, new_state):
		self._setter_access_tracker["TextBox560"] = {}
		global default_state
		self._TextBox560 = TextBox(new_state, default_state["TextBox560"])

	@property
	def Div26lay(self):
		self._getter_access_tracker["Div26lay"] = {}
		return self._Div26lay
	@Div26lay.setter
	def Div26lay(self, new_state):
		self._setter_access_tracker["Div26lay"] = {}
		global default_state
		self._Div26lay = Div(new_state, default_state["Div26lay"])

	@property
	def TextBox561(self):
		self._getter_access_tracker["TextBox561"] = {}
		return self._TextBox561
	@TextBox561.setter
	def TextBox561(self, new_state):
		self._setter_access_tracker["TextBox561"] = {}
		global default_state
		self._TextBox561 = TextBox(new_state, default_state["TextBox561"])

	@property
	def TextBox562(self):
		self._getter_access_tracker["TextBox562"] = {}
		return self._TextBox562
	@TextBox562.setter
	def TextBox562(self, new_state):
		self._setter_access_tracker["TextBox562"] = {}
		global default_state
		self._TextBox562 = TextBox(new_state, default_state["TextBox562"])

	@property
	def Image331(self):
		self._getter_access_tracker["Image331"] = {}
		return self._Image331
	@Image331.setter
	def Image331(self, new_state):
		self._setter_access_tracker["Image331"] = {}
		global default_state
		self._Image331 = Image(new_state, default_state["Image331"])

	@property
	def TextBox563(self):
		self._getter_access_tracker["TextBox563"] = {}
		return self._TextBox563
	@TextBox563.setter
	def TextBox563(self, new_state):
		self._setter_access_tracker["TextBox563"] = {}
		global default_state
		self._TextBox563 = TextBox(new_state, default_state["TextBox563"])
	...
	def _to_json_fields(self):
		return {
			...
			"Div40": self._Div40,
			"Flex827": self._Flex827,
			"Flex825": self._Flex825,
			"Div37card": self._Div37card,
			"Flex820": self._Flex820,
			"Div38card": self._Div38card,
			"Flex821": self._Flex821,
			"Div39card": self._Div39card,
			"Flex822": self._Flex822,
			"Flex826": self._Flex826,
			"Div2card": self._Div2card,
			"Div3lay": self._Div3lay,
			"Flex797content": self._Flex797content,
			"Div25card": self._Div25card,
			"Flex814": self._Flex814,
			"Div27card": self._Div27card,
			"Flex815": self._Flex815,
			"Image2": self._Image2,
			...
			"Div34lay": self._Div34lay,
			"TextBox573": self._TextBox573,
			"Image335": self._Image335,
			"TextBox574": self._TextBox574,
			"TextBox575": self._TextBox575,
			"Div35lay": self._Div35lay,
			"TextBox576": self._TextBox576,
			"Image336": self._Image336,
			"TextBox577": self._TextBox577,
			"TextBox578": self._TextBox578,
			"Div36lay": self._Div36lay,
			"TextBox579": self._TextBox579,
			"TextBox580": self._TextBox580,
			"Image337": self._Image337,
			"TextBox581": self._TextBox581,
			"TextBox531": self._TextBox531,
			"TextBox530": self._TextBox530,
			"Image320": self._Image320,
			"TextBox536": self._TextBox536,
			"Div24lay": self._Div24lay,
			"TextBox558": self._TextBox558,
			"TextBox559": self._TextBox559,
			"Image330": self._Image330,
			"TextBox560": self._TextBox560,
			"Div26lay": self._Div26lay,
			"TextBox561": self._TextBox561,
			"TextBox562": self._TextBox562,
			"Image331": self._Image331,
			"TextBox563": self._TextBox563,
			}
